...
-(id)initWithFrame:(CGRect)frame {
    ...
    if ([super initWithFrame:frame]) {
        ...
        self.backgroundColorScrollView =[UIColor lightGrayColor];// [UIColor colorWithRed:34.0/255.0 green:34.0/255.0 blue:34.0/255.0 alpha:1.0];
        self.backgroundColorLines =[UIColor blackColor];// [UIColor colorWithRed:51.0/255.0 green:181.0/255.0 blue:229.0/255.0 alpha:1.0];
        ...
        self.fontColorLabelSelected  =[UIColor colorFromHexString:@"#25AAA0"];;// [UIColor colorWithRed:51.0/255.0 green:181.0/255.0 blue:229.0/255.0 alpha:1.0];
...
- (void)buildHeader {
   ...
   // NSLog(@"kFlatDatePickerHeaderHeight: %d", kFlatDatePickerHeaderHeight);
    ...
    _buttonClose.backgroundColor = [UIColor redColor];
    ...
    _buttonValid.backgroundColor =[UIColor colorFromHexString:@"#25AAA0"];// kFlatDatePickerBackgroundColorButtonValid;
